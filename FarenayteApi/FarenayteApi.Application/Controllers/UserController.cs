using FarenayteApi.Domain.Entities;
using FarenayteApi.Domain.Interfaces;
using FarenayteApi.Service.Validators;
using Microsoft.AspNetCore.Mvc;
using System;

namespace FarenayteApi.Application.Controllers
{
